...
<Modal v-bind:visible="visible" v-bind:close="closeModal">
    ...
    <label for="mail-list" class="checkbox__label">Yes, I want to subscribe to the Imagine X mailing list</label>
    <button class="btn--full u-margin--top" @click.prevent='closeModal'>Sign in & Endorse nominee</button>
</Modal>
</template>
