<template>
	<div id="nominees">
		<p>This is a crowd-sourced list of independent candidate nominees for the upcoming BC provincial election nominated by British Columbians like you. The nominees are not officially registered with Elections BC unless otherwise indicated. If you like an existing nominee, show your support and enthusiasm by endorsing their nomination! If we can, we will even try to contact the nominees to let them know about their public endorsement. Nominees listed are submitted by users and are not endorsed by Imagine X in any way.</p>
