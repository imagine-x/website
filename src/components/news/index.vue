...
<div>
	...
	<div class="row container">
		<div class="four columns layout__sidebar u-hide-at-sm">
		...
		<div class="eight columns layout__main">
            ...
            <p>Over the next few months leading up to the next provincial election, Imagine X will be releasing series of initiatives that will continue to highlight and challenge the partisan polarization in B.C. politics.</p>
            <b>Quotes</b>
            <b>Fred Bantados, Spokesperson for Imagine X</b>
            <p>“As Imagine X, we want to bring public awareness to the political divisiveness and lack of independent thought in the B.C. legislature. Creating this MLA voting records app is one of our first steps. We think that accessible voting records of B.C. MLAs displayed in a meaningful way for the public to consume is vital to a healthy and transparent democracy. The data clearly shows that our current MLAs usually only vote along the party lines above all else. We need to reimagine politics and rethink how we can bring democracy back to the people in B.C.”</p>
            <b>Sean Holman, Documentary Filmmaker of <i>Whipped: the secret world of party discipline</i></b>
            <p>“Most MLAs will only ever vote and voice the party line, giving a government with a majority in the legislature the power to do whatever it wants between elections. That’s not much of a democracy, something I illustrated in my 2013 documentary, Whipped: the secret world of party discipline. As this project from Imagine X shows, not much has changed since then. But, if British Columbians do want such a change, they need to be thinking about how to elect more MLAs who will actually listen to them and their own conscience.”</p>
            <b>Quick Facts</b>
            <ul>
                <li>Data analysed is from 109 standing votes recorded in the first to fifth session of the 40th Parliament of the Legislative Assembly of B.C. from July 2013 to July 2016.</li>
                <li>In the period analysed, only 1.8% (two votes) were cast out of party lines by a total five MLAs from the B.C. Liberal caucus.</li>
                <li>100% of the votes initiated by the government (B.C. Liberals) were passed, while 100% of the votes initiated (i.e. motions moved) by the Opposition or independent members of the legislature failed.</li>
                <li>The last time a government bill was defeated was in 1953 (2013, Sean Holman).</li>
                <li>The source of the data is Hansard provided by the Legislative Assembly of B.C.</li>
            </ul>
            <b>About Imagine X</b>
            <p>Imagine X is a political platform. We are a group of passionate citizens starting a political movement to reimagine politics and reimagine BC. Our backgrounds range from economics, philosophy, political science and arts to technology, medicine, business and education. We are united by our stand for a good government with principles and policies that meet our core values. We are not affiliated with the BC Liberals, NDPs, Greens, any other existing political party or interest group. We simply want a better government for a even better BC. Visit www.imagine-x.ca for more information.</p>
            <b>Learn More</b>
